...
<p>มาเรียนรู้เทคนิคการทำโฆษณาออนไลน์ให้มีประสิทธิภาพกับเรา!</p>
<div className="text-center">
<div className="imgc">
  <img src="/img/class.jpg" className='imgp'  alt="คอร์สเรียนโฆษณา"width={380} height={250} />
  </div>
            </div>
            <div className="text-center">
           
            <img src="/img/Facebook.png" alt="Google_Ads_สายเทา" width={200} height={200}/>
</div>
<hr />
<ul>
